...
export function ConfirmDeleteDialog({ open, title, description, loading, onCancel, onConfirm }: ConfirmDeleteDialogProps) {
  ...
  const titleId = useId()
  const descId = useId()
  useModalBehaviour({ open, onClose: onCancel, panelRef: panel })
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      <div
        ...
        className="relative w-full sm:max-w-sm bg-white dark:bg-zinc-900 rounded-t-2xl sm:rounded-2xl shadow-xl z-10 p-6"
      >
